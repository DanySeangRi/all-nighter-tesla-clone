...
const Map = () => {
  ...
  return (
    <div className="w-full bg-white">
      ...
      <div className="min-w-107.5   sm:px-6 xl:px-12 py-6 xl:py-10">
        <div className="flex flex-col gap-12">
          {/* ================= MAP ================= */}
          <div className="relative w-full h-75 sm:h-100 xl:h-137.5 overflow-hidden rounded-none xl:rounded-lg">
            <iframe
          ...
          {/* ================= CONTENT ================= */}
          <div className="px-4 sm:px-6 md:px-10 xl:p-3">
            {/* Header + Stats row */}
