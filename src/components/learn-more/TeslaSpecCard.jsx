...
const TeslaSpecCard = () => {
 ...
 <div className="bg-black text-white min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="border-t border-gray-800 px-6 lg:px-24 pt-8 lg:pt-12 mb-8 lg:mb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-32">
            <div>
              <div className="text-sm text-gray-400 mb-1 lg:mb-2">Supercharging</div>
              <div className="text-sm text-gray-400 mb-1 lg:mb-2">Max/Payment Type</div>
        ...
        {/* Footnotes */}
        <div className="px-6 lg:px-24 py-8 text-xs lg:text-sm text-gray-300 space-y-3">
      ...
      <div
  className="relative h-64 sm:h-80 md:h-96 lg:h-175 xl:h-125 bg-cover bg-center"
  style={{ 
...
>
        ...
        {/* Content */}
        <div className="relative h-100 flex flex-col items-center justify-center text-white px-4">
          <h1 className="text-3xl sm:text-5xl md:text-6xl font-medium mb-6">
            Model Y Standard
          </h1>
          <button className="bg-blue-600 hover:bg-blue-700 text-white px-10 py-2 rounded text-sm font-medium transition ">
            Design Yours
          </button>
        </div>
        {/* footer */}
        <div className=" absolute left-120 -bottom-10">
          <Footer />
        </div>
      </div>
    </div>
