    ...
    <section className="w-full ">
      ...
      <div className="pb-[104px] pt-[80px] mx-auto md:pb-[160px]">
        <div className="text-center mb-8 md:mb-12">
          <h2 className="text-[40px] md:text-4xl font-semibold mb-2 ">
            {title.maintitle}
          </h2>
          <p className="text-[24px] text-black font-medium mb-2">
            {title.subtitle1}
          </p>
        ...
        <div className="relative group/carousel">
          ...
          <button
            ...
            className={`absolute hidden md:block mx-10 left-2 md:-left-6 top-1/2 -translate-y-1/2 bg-white p-2 rounded-md shadow-lg z-10 transition-all duration-300 hover:bg-gray-100 ${
              currentIndex === 0
          ...
          <button
            onClick={() => scrollToIndex(currentIndex + 1)}
            className={`absolute hidden sm:block mx-10 right-2 md:-right-6 top-1/2 -translate-y-1/2 bg-white p-2 rounded-md shadow-lg z-10 transition-all duration-300 hover:bg-gray-100 ${
