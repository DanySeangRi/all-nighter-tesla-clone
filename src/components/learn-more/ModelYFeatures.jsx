        ...
        <section className='max-w-360 mx-auto bg-white overflow-hidden font-sans antialiased' style={{ fontFamily: '"Universal Sans Display", -apple-system, Arial, sans-serif' }}>
            ...
            <section className='third-card mt-24 md:mt-36'>
                <div className='px-6 md:px-12 xl:px-40'>
                    <div className='max-w-279 mx-auto'>
                        <div className='card'>
                            <div className=' md:px-12'>
                                <div className='w-full h-122.5 min-[1440px]:h-168 bg-amber-400 relative rounded-none min-[431px]:rounded-xl overflow-hidden'>
                                    {/* REPLACED WITH NEW COMPONENT */}
                ...
                <div className='px-6 md:px-12 xl:px-40 mt-8 md:mt-7.5'>
                    <div className='max-w-7xl mx-auto'>
            ...
            <section className='card mt-20 md:mt-20 px-6 md:px-12 xl:px-40'>
                <div className='flex flex-col lg:flex-row-reverse items-start gap-8 lg:gap-12 pt-20 pb-30'>
                    <div className='flex-[1.2] w-full order-1 lg:order-2 min-[1440px]:flex-none min-[1440px]:w-193.5'>
                        <div className='w-full h-92.25 xl:h-132 min-[1440px]:h-132 bg-amber-400 relative rounded-xl overflow-hidden'>
                ...
                <div className='flex flex-col lg:flex-row items-start gap-8 lg:gap-12 pb-38'>
                    <div className='flex-[1.2] w-full order-1 lg:order-2 min-[1440px]:flex-none min-[1440px]:w-193.5'>
                        <div className='w-full h-92.25 xl:h-132 min-[1440px]:h-132 bg-amber-400 relative rounded-xl overflow-hidden'>
            ...
            <section className='six-card mt-24 md:mt-36'>
                ...
                <div className='card mt-24 md:mt-36'>
                    <div className='px-0 md:px-12'>
                        <div className='w-full h-122.5 min-[1440px]:w-336 min-[1440px]:h-145 mx-auto bg-amber-400 relative rounded-none md:rounded-xl overflow-hidden'>
                ...
                <div className='three-box mt-10 md:mt-20 flex flex-col md:flex-row items-center justify-center xl:justify-between gap-y-12 md:gap-x-12 px-6 md:px-12 xl:px-40 text-black w-full font-sans'>
                    <div className='flex flex-col items-center md:items-start min-w-50'>
                        <div className='flex items-baseline gap-1 mb-2'>
                            <span className='text-[48px] md:text-[48px] font-bold tracking-[-1.5px] leading-none '>15</span>
                    ...
                    <div className='flex flex-col items-center md:items-start min-w-50'>
                        <div className='flex items-baseline gap-1 mb-2'>
                            <span className='text-[48px] md:text-[48px] tracking-[-1.5px] leading-none font-medium '>99</span>
                ...
                {/* --- SECTION 9: SAFETY --- */}
                <div className='card md:pt-38 px-6 md:px-12 xl:px-25'>
                    <div className='max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-start gap-8 lg:gap-12'>
                        <div className='flex-1 w-full'>
                            <h1 className='text-[40px] xl:text-[48px] text-[#171A20] font-semibold leading-tight'>Engineered for Your Safety</h1>
                            <div className='mt-6 text-[20px] xl:text-[20px] text-[#5C5E62] leading-normal max-w-md space-y-6'>
                        ...
                        <div className='flex-1 w-full min-[1440px]:flex-none min-[1440px]:w-193.5'>
                            <div className='w-full h-92.25 xl:h-132 min-[1440px]:h-132 bg-amber-400 relative rounded-xl overflow-hidden'>
